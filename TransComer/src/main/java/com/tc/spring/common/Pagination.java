...
public class Pagination {
   ...
   public static SimplePageInfo getSimplePageInfo(int spCurrentPage, int spListCount) {
	      ...
	      spi = new SimplePageInfo(spCurrentPage, spListCount, spPageLimit, spMaxPage, spStartPage, spEndPage, spBoardLimit);
	   ...
	   public static AlarmPageInfo getAlarmPageInfo(int arCurrentPage, int arListCount) {
	      ...
	      aPi = new AlarmPageInfo(arCurrentPage, arListCount, arPageLimit, arMaxPage, arStartPage, arEndPage, arBoardLimit);
