                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="/" method="post" id="personalForm">
                            ...
                            <input type="hidden">
                            <textarea rows="20" required></textarea>
                            <hr>
                            <div class="d-flex justify-content-center">
                                <button type="submit" name="" class="btn btn-primary">결과 등록하기</button>
                                &nbsp;&nbsp;&nbsp;
                                <a href="#" class="btn btn-secondary" style="text-decoration: none">취소하기</a>
                            </div>
                        </form>
                    </div>
                </div>
