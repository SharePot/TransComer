				                                        ...
				                                        <tr>
				                                            ...
				                                            <td>
				                                                <div class="input-group mb3 searchDiv">
				                                                    <input type="text" class="form-control" name="reportSearch" placeholder="검색어 입력" size="50" autocomplete="off">
				                                        ...
				                                        <tr>
				                                            ...
				                                            <td>
				                                                <div class="input-group mb3 searchDiv">
				                                                    ...
				                                                    <input type="hidden" name="type" value="all" id="search_Bparam">
				                                                </div>
				                                            </td>
				                                        </tr>
				                                    </table>
