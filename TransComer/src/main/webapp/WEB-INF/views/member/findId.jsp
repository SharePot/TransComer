    ...
    <body>
        <div class="wrapper fadeInDown">
              <div id="formContent">
				...
				<!--<form action="" method="post" id="formInfo">
                  <input type="text" id="mPhone" class="fadeIn second" name="Phone" placeholder="전화번호" maxlength="13" >-->
                                 
                                 
                 <!-- <div class="row">
                    <div >
                    <input type="text" id="mPhone" class="fadeIn  third" name="phone" placeholder="전화번호" maxlength="13" style="width: 133.5%">
                    </div>
