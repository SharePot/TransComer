...
<html lang="ko">
	...
	<body class="homepage is-preload">
								...
								<br>
									<br>
										...
										<!--onchange 피라미터 갯수를 스크립트의 갯수와 동일하게 입력 -->
											...
											<input style="background-color: white; width: 45%;"
											type="file" name="fileNo1" onchange="Check(this, 2)">
			
											&nbsp;
											
											<input
												style="background-color: white; width: 45%; margin-right: 5px;"
												type="file" name="fileNo2" onchange="Check(this, 2)">
												<br>
							</div>
							<br>
								<!--TextArea -->
								<div class="d-flex justify-content-center">
									...
									<textarea
										...
										rows="5" cols="200" name="contents"
										placeholder=" 페이지의 설명과 신청이유를 적어주세요." class="form-control">
								...
								<br>
									...
									<div style="text-align: center;">
										<input type="button" id="" value="돌아가기">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="button" name="" value="신청하기">
									</div>
									<br>
		...
		<script>
			//파일 용량 체크
			function Check(info, mb){
			if (info.files[0].size > 10
			* 1024 * 1024 * mb){ //단위는 MB
